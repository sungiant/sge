...
#include "sge_types.hpp"                // todo: remove need for this dependency
#include "sge_math.hpp"

// sge::runtime's public interface should not know about the details of sge::core so don't include sge_core.hpp in this file.
